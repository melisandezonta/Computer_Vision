...
image_noisy_smoothed = cv2.GaussianBlur(img_noisy_gray, (3,3), 0)
...
edges_noisy_smoothed_image = cv2.Canny(image_noisy_smoothed,600,1200,1,5,True)
...
a_new_hough, b_new_hough, r_new_hough = filter_circles(a_hough,b_hough,r_hough,50.0)
